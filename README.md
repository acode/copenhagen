...
To get started with Copenhagen, add `copenhagen.0-1-1.min.css`
and `copenhagen.0-1-1.min.js` to your web project.
...
```html
<!-- Copenhagen Editor -->
<link rel="stylesheet" href="./compiled/copenhagen.0-1-1.min.css">
<script src="./compiled/copenhagen.0-1-1.min.js"></script>
```
